...
@Service
@Slf4j
public class SunbirdEsUtilServiceImpl implements EsUtilService{
    ...
    public SunbirdEsUtilServiceImpl(
            @Qualifier("sunbirdElasticsearchClient") ElasticsearchClient elasticsearchClient,
            EsConfig esConfig,
