...
public class Constants {
    ...
    public static final String REDIS_DATA_PASSWORD_REQUIRED = "redis.data.password.required";
    public static final String REDIS_DATA_PASSWORD = "redis.data.password";
