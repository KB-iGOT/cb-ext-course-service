...
public class ExternalTrainingCertificateServiceImpl {
    ...
    public void generateCertificateEventAndPushToKafka(String userId, String eventId, String batchId, double completionPercentage, long etsForEvent, boolean reissue) throws IOException {
        List<String> userIds = Collections.singletonList(userId);
        String eventJson = generateIssueCertificateEvent(batchId, eventId, userIds, completionPercentage, userId, etsForEvent, reissue);
    ...
    public String generateIssueCertificateEvent(String batchId, String eventId, List<String> userIds, double eventCompletionPercentage, String userId, long ets, boolean reissue) throws JsonProcessingException {
